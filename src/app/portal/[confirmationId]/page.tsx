...
export default async function PortalPage({
  ...
  const payload = resolvePortal(confirmationId, fallback);
      ...
      <div className="py-24">
        <Container className="max-w-lg text-center">
          ...
          <p className="mt-4 text-paper-200/70">
            Double-check the confirmation ID, or use the direct link from your booking
            confirmation email — it carries a few extra details that make this easier to find.
          </p>
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Button href="/portal">Try Again</Button>
